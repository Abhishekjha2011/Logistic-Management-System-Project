...
public class Login_FE extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String us_id=Rt2.getText();
        String dob=Rt3.getText();
        String phn=Rt4.getText();
        ...
        if(pswrd == null ? cpswrd == null : pswrd.equals(cpswrd))
        {
            ...
            { 
                ...
                String Registartion="insert into reg_login(E_NAME,E_DOB,E_Phn,E_UserId,E_Pswd) values ('"+name+"','"+dob+"','"+phn+"','"+us_id+"','"+cpswrd+"');";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if((uname!=null)&&(pass!=null))
        {
            try
            {
                ...
                String query="select E_UserId,E_PSWD from reg_login where E_UserId='"+uname+"';";
                ResultSet rs=s.executeQuery(query);
                while(rs.next())
                {
                    String user=rs.getString("E_UserId");
